    ...
    <>
      ...
      <section className="mt-4 rounded-3xl border border-slate-300 bg-slate-50 p-5 shadow-sm">
        ...
        <div className="mt-4 grid gap-3">
          <details className="group overflow-hidden rounded-xl border border-slate-300 bg-slate-50" open>
            <summary className="cursor-pointer list-none bg-slate-100 px-4 py-3 text-sm font-bold">
            ...
            <div className="grid gap-3 px-4 pb-4 pt-2 text-slate-800 md:grid-cols-2">
              ...
              <div className="grid min-h-56 overflow-hidden rounded-xl border-2 border-dashed border-slate-300 bg-white">
                <img
          ...
          <details className="group overflow-hidden rounded-xl border border-slate-300 bg-slate-50">
            <summary className="cursor-pointer list-none bg-slate-100 px-4 py-3 text-sm font-bold text-emerald-800">
              <div className="flex items-center justify-between">
            ...
            <div className="overflow-x-auto px-4 pb-4 pt-2 text-slate-800">
              <table className="w-full min-w-full border-collapse text-sm">
                <thead>
                  <tr>
                    <th className="border border-slate-300 bg-slate-100 px-3 py-2 text-left text-slate-900">Capacidad</th>
                    <th className="border border-slate-300 bg-slate-100 px-3 py-2 text-left text-slate-900">Precio referencia</th>
                    <th className="border border-slate-300 bg-slate-100 px-3 py-2 text-left text-slate-900">Detalle</th>
                  </tr>
                </thead>
                <tbody>
                  {airInstallPricing.map((item) => (
                    <tr key={item.btu}>
                      <td className="border border-slate-300 px-3 py-2 align-top font-semibold text-slate-900">{item.btu}</td>
                      <td className="border border-slate-300 px-3 py-2 align-top text-base font-extrabold text-emerald-700">
                        {item.referencePrice}
                      </td>
                      <td className="border border-slate-300 px-3 py-2 align-top text-slate-700">{item.details}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <details className="group overflow-hidden rounded-xl border border-slate-300 bg-slate-50">
            <summary className="cursor-pointer list-none bg-slate-100 px-4 py-3 text-sm font-bold text-cyan-800">
              <div className="flex items-center justify-between">
                <span>Hidrolavado: precios por BTU</span>
                <span className="group-open:hidden">+</span>
                <span className="hidden group-open:inline">-</span>
              </div>
            </summary>
            <div className="grid gap-3 px-4 pb-4 pt-2 text-slate-800 sm:grid-cols-2">
              {airHydroWashPricing.map((item) => (
                <article key={item.btu} className="rounded-xl border border-slate-300 bg-slate-50 p-4">
                  <p className="text-sm font-bold uppercase tracking-wide text-slate-900">{item.btu}</p>
                  <div className="mt-3 grid gap-2">
                    <div className="flex items-center justify-between rounded-lg border border-slate-300 bg-slate-50 px-3 py-2">
                      <span className="text-sm font-semibold text-slate-900">Simple</span>
                      <span className="text-lg font-extrabold text-emerald-700">{item.simple}</span>
                    </div>
                    <div className="flex items-center justify-between rounded-lg border border-slate-300 bg-slate-50 px-3 py-2">
                      <span className="text-sm font-semibold text-slate-900">Completo</span>
                      <span className="text-lg font-extrabold text-blue-700">{item.complete}</span>
                    </div>
                  </div>
                </article>
              ))}
            </div>
            <p className="mx-4 mb-4 rounded-lg border border-slate-300 bg-slate-50 px-3 py-2 text-sm font-semibold text-slate-900">
              Para equipos mas grandes: consultar.
            </p>
          </details>

          <details className="group overflow-hidden rounded-xl border border-slate-300 bg-slate-50">
            <summary className="cursor-pointer list-none bg-slate-100 px-4 py-3 text-sm font-bold text-rose-800">
              <div className="flex items-center justify-between">
            ...
            <div className="grid gap-4 px-4 pb-4 pt-2 text-slate-800">
              <div>
                <p className="text-sm font-bold text-slate-900">Desinstalacion</p>
                <div className="mt-2 grid gap-2 sm:grid-cols-3">
                  {airUninstallPricing.map((extra) => (
                    <article key={extra.item} className="rounded-xl border border-slate-300 bg-slate-50 p-3">
                      <p className="text-sm font-semibold text-slate-900">{extra.item}</p>
                      <p className="mt-1 text-lg font-extrabold text-rose-700">{extra.price}</p>
                    </article>
                  ))}
                </div>
              </div>
              ...
              <div>
                <p className="text-sm font-bold text-slate-900">Precio de mensulas</p>
          ...
          <details className="group overflow-hidden rounded-xl border border-slate-300 bg-slate-50">
            ...
            <ul className="columns-1 space-y-1 px-4 pb-4 pl-9 pt-2 text-slate-900 sm:columns-2">
          ...
          <details className="group overflow-hidden rounded-xl border border-slate-300 bg-slate-50">
            ...
            <div className="grid gap-2 px-4 pb-4 pt-2 text-slate-800">
              {airFaq.map((faq) => (
                <details key={faq.question} className="group/item overflow-hidden rounded-lg border border-slate-300 bg-slate-50">
